...
tree short_unsigned_array_type_node;
#endif  /* NeXT */
...
#ifndef NeXT  /* A temporary implicit decl causes a crash in pushdecl. */
...
init_decl_processing ()
{
  ...
  short_unsigned_array_type_node
    = build_array_type (short_unsigned_type_node, unsigned_char_type_node);
#endif  /* NeXT */
