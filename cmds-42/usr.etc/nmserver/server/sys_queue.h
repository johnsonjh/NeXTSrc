 ...
 * sys_queue.h
 *
 * Hacks to include <sys/queue.h> while avoiding name conflicts
 * with cthreads.h and rwlock.h.
 *
 * $Source: /os/osdev/LIBS/libs-7/etc/nmserver/server/RCS/sys_queue.h,v $
 *
 * $Header: sys_queue.h,v 1.1 88/09/30 15:45:38 osdev Exp $
 *
 */
/*
 * HISTORY:
