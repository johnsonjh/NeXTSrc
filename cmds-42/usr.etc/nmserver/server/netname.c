 ...
 * netname.c
 *
 * $Source: /os/osdev/LIBS/libs-7/etc/nmserver/server/RCS/netname.c,v $
 *
 */

#ifndef	lint
char netname_rcsid[] = "$Header: netname.c,v 1.1 88/09/30 15:40:33 osdev Exp $";
#endif not lint
 ...
 *	Use bootstrap_check_in instead of bootstrap_checkin.
 *
 * 27-Mar-90  Gregg Kellogg (gk) at NeXT
 *	Use bootstrap_checkin instead of service_checkin.
 *
