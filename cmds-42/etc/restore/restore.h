...
#if	NeXT
extern int	ejectable;	/* set if restoring from floppy or optical */
#endif	NeXT
/*
 * Global variables
 */
#if	NeXT
extern char	*volmap; 	/* map of dump tape volumes */
#endif	NeXT
...
#if	NeXT
#define	VOLSIZE	8192	/* Maximum number of volumes that we will deal with */
#endif	NeXT
