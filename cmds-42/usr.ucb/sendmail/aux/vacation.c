/* @(#)vacation.c	1.1 87/08/31 3.2/4.3NFSSRC */
/*
**  Vacation
...
#ifndef lint
static char	SccsId[] = "@(#)vacation.c 1.6 86/07/16 SMI"; /* from UCB 5.3 7/1/85 */
#endif not lint
	...
	char *myname;
{
	...
	if (f == NULL)
	{
		f = freopen("/etc/sendmail/vacation.def", "r", stdin);
		if (f == NULL)
