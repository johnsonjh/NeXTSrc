...
static char sccsid[] = "@(#)lgamma.c	4.4 (Berkeley) 9/11/85";
#endif
...
const static double goobie = 0.9189385332046727417803297; /* log(2*pi)/2 */
const static double pi     = 3.1415926535897932384626434;
