...
#include "gmon.h"
	...
	.text
	.even
	.stabs "crt0.s",100,0,0,L_start
L_start:
.stabs "int:t1=r1;-2147483648;2147483647;",128,0,0,0
.stabs "char:t2=r2;0;127;",128,0,0,0

.stabs "environ:G16=*17=*2",32,0,4,0
.globl _environ
.data
	.even
_environ:
	.long 0
.stabs "NXArgc:G1",32,0,3,0
.globl _NXArgc
	.even
_NXArgc:
	.long 0
.stabs "NXArgv:G16=*17=*2",32,0,4,0
.globl _NXArgv
	.even
_NXArgv:
	.long 0
...
start:
	...
	jbsr	__init_shlibs	| initialize shared libraries
...
1:
	...
	tstl	__objcInit
	beq	1f
	jbsr	__objcInit 	| initialize Objective-C runtime support.
1:
#endif POSTSCRIPT
	clrl	_errno
...
overflow:
	...
	.text
eprol:
	nop	| This is here so that eprol and the next text symbol will not
		| have the same address and possibly confuse scattered loading
