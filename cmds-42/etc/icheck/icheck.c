...
#ifndef lint
static char sccsid[] = "@(#)icheck.c  1.2 88/03/10 4.0NFSSRC; from    5.1 (Berkeley) 5/28/85";
#endif not lint
...
#ifndef STANDALONE
#ifdef NeXT_MOD
	printf("files %6u (r=%u,d=%u,b=%u,c=%u,sl=%u (reg %u fast %u))\n",
		i, nrfile, ndfile, nbfile, ncfile, nlfile, num_reglinks,
	        num_fastlinks);
#else
...
#else
#ifdef NeXT_MOD
	printf("files %u (r=%u,d=%u,b=%u,c=%u,sl=%u (reg %u fast %u))\n",
		i, nrfile, ndfile, nbfile, ncfile, nlfile, num_reglinks,
	        num_fastlinks);
#else
