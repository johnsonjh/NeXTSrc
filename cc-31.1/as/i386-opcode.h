...
/* "movsbl" & "movsbw" must not be unified into "movsb" to avoid
   ...
   {"movsb", 2, 0x0fbe, _, movextendKludge|Modrm, Reg8|Mem,  Reg16|Reg32, 0},
   is not kosher; we must seperate the two instructions. */
{"movsbl", 2, 0x0fbe, _, movextendKludge|Modrm, Reg8|Mem,  Reg32, 0},
{"movsbw", 2, 0x660fbe, _, movextendKludge|Modrm, Reg8|Mem,  Reg16, 0},
{"movswl", 2, 0x0fbf, _, movextendKludge|Modrm, Reg16|Mem, Reg32, 0},

/* move with zero extend */
{"movzb", 2, 0x0fb6, _, movextendKludge|Modrm, Reg8|Mem, Reg16|Reg32, 0},
{"movzwl", 2, 0x0fb7, _, movextendKludge|Modrm, Reg16|Mem, Reg32, 0},

/* push instructions */
{"push", 1, 0x50, _, ShortForm, WordReg,0,0 },
{"push", 1, 0xff, 0x6,  Modrm, WordReg|WordMem, 0, 0 },
{"push", 1, 0x6a, _, NoModrm, Imm8, 0, 0},
...
{"add", 2, 0x83, 0,  Modrm, Imm8, WordReg|WordMem, 0},
...
{"sub", 2, 0x83, 5,  Modrm, Imm8,WordReg|WordMem, 0},
...
{"mul", 2, 0xf6, 4, W|Modrm, Reg|Mem, Acc, 0},
{"imul", 2, 0xf6, 5, W|Modrm, Reg|Mem, Acc, 0},
{"imul", 2, 0x0faf, _, Modrm, WordReg|Mem, WordReg, 0},
{"imul", 3, 0x6b, _, Modrm, Imm8, WordReg|Mem, WordReg},
{"imul", 3, 0x69, _, Modrm, Imm16|Imm32, WordReg|Mem, WordReg},
/*
  imul with 2 operands mimicks imul with 3 by puting register both
  in i.rm.reg & i.rm.regmem fields
*/
{"imul", 2, 0x6b, _, Modrm|imulKludge, Imm8, WordReg, 0},
...
{"lcall", 2, 0x9a, _, JumpInterSegment, Abs16, Abs32, 0},
...
{"ljmp", 2, 0xea, _, JumpInterSegment, Abs16, Abs32, 0},
{"ljmp", 1, 0xff, 4, Modrm, Mem, 0, 0},
...
{"jcxz", 1, 0xe3, _, JumpByte, Disp, 0, 0},
{"jecxz", 1, 0x66e3, _, JumpByte, Disp, 0, 0},
...
/* bit manipulation */
{"bsf", 2, 0x0fbc, _, Modrm, Reg|Mem, Reg, 0},
{"bsr", 2, 0x0fbd, _, Modrm, Reg|Mem, Reg, 0},
...
{"lar", 2, 0x0f02, _, Modrm, WordReg|Mem, WordReg, 0},
...
{"lsl", 2, 0x0f03, _, Modrm, WordReg|Mem, WordReg, 0},
...
/* this is really a fdiv (see above) */
...
prefix_entry i386_prefixtab[] = {
  { "aword", 0x67 },		/* address size prefix ==> 16bit addressing
				 * (How is this useful?) */
#define WORD_PREFIX_OPCODE 0x66
  { "word", 0x66 },		/* operand size prefix */
