 ...
 * nmtest.c
 *
 * $Source: /os/osdev/LIBS/libs-7/etc/nmserver/utils/RCS/nmtest.c,v $
 *
 */
#ifndef	lint
static char     rcsid[] = "$Header: nmtest.c,v 1.1 88/09/30 15:47:07 osdev Exp $";
#endif not lint
/*
