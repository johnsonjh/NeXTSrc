...
/* For FUNCTION_TYPE or METHOD_TYPE, a list of the exceptions that
   this type can raise.  */
#define TYPE_RAISES_EXCEPTIONS(NODE) TYPE_NAME (NODE)

...
#ifdef NeXT_OBJC
extern tree current_lang_name, lang_name_objc, lang_name_cplusplus, lang_name_c;
#else
extern tree current_lang_name, lang_name_cplusplus, lang_name_c;
#endif

extern tree hack_identifier (), hack_operator (), hack_wrapper ();
extern tree convert_pointer_to (), convert_to_reference (), convert_to_aggr (), convert_aggr ();
...
#define IN_CHARGE_NAME "__in$charge__"
