...
static char sccsid[] = "@(#)expm1.c	1.2 (Berkeley) 8/21/85";
#endif
...
#else	/* IEEE double */
#ifdef	NeXT
#define ln2hi  (6.9314718036912381649E-1)  /*Hex  2^ -1   *  1.62E42FEE00000 */
#define ln2lo  (1.9082149292705877000E-10) /*Hex  2^-33   *  1.A39EF35793C76 */
#define lnhuge (7.1602103751842355450E2)   /*Hex  2^  9   *  1.6602B15B7ECF2 */
#define invln2 (1.4426950408889633870E0)   /*Hex  2^  0   *  1.71547652B82FE */
#else
double static
