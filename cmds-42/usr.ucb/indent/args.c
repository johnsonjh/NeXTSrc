 ...
 */
    "osa",	PRO_BOOL,	true,	ON,	&convert_old_assignment,
    "nosa",	PRO_BOOL,	true,	OFF,	&convert_old_assignment,
#else
 ...
 /* 12/18/86 wrp added to allow use on devices with different tab stops */
