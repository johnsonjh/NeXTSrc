 ...
 * config.h
 *
 * $Source: /os/osdev/LIBS/libs-7/etc/nmserver/build/RCS/config.h,v $
 *
 * $Header: config.h,v 1.1 88/09/30 15:21:22 osdev Exp $
 *
 */
...
#define	LongAlign		1
#define	VaxOrder		0
#endif	defined(NeXT) || defined(sun)
...
#ifndef	NET_LOG
#define	NET_LOG		0	/* was 1 */
#endif	NET_LOG
#ifndef	NET_DEBUG
#define	NET_DEBUG	0	/* was 1 */
#endif	NET_DEBUG
#ifndef	NET_TRACE
#define	NET_TRACE	0
#endif	NET_TRACE
...
#define USE_CRYPT		0	/* use encryption at all */
#define USE_CRYPT_XOR		0
#define USE_CRYPT_NEWDES	0
#define USE_CRYPT_MULTPERM	0
#define USE_CRYPT_DES		0
...
#define GOOD_MALLOC	1	/* malloc can be used for all allocs */
