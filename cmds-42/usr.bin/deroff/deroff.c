...
#ifdef NeXT_MOD
	M(NONE,		'f','p',	skip),	/* mount font */
	M(NONE,		'f','z',	skip),	/* change font pt size */
	M(NONE,		'b','d',	skip),	/* embolden font */
	M(NONE,		'f','t',	skip),	/* change font */
	M(NONE,		'u','f',	skip),	/* underline font */
	M(NONE,		't','r',	skip),	/* translate input */
	M(NONE,		'a','b',	skip),	/* abort with msg */
#endif NeXT_MOD
	M(NONE,		0,0,		0)
};
/*
