 ...
 *	Removed directory from shell paths since they will be
 *	used in execvp() call.
 *
 * 23-Oct-83  David Nichols (nichols) at Carnegie-Mellon University
 *	Conditionalize definition for NOFILE and NCARGS since we import
 *	sys/param.h.
 *
 **********************************************************************
 */
