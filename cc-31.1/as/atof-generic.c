...
/*    last_digit = p; JF unused */
    ...
    /* SCS: Add support for Infinity, etc. (see atof-m68k.c) */
    if ((strcmp(p, "Infinity") == 0) || (strcmp(p, "infinity") == 0) ||
	(strcmp(p, "NaN") == 0) || (strcmp(p, "nan") == 0) ||
	(strcmp(p, "SNaN") == 0) || (strcmp(p, "snan") ==0)) {
                  while(*p) p++;
    }
