...
static char sccsid[] = "@(#)j1.c	4.2 (Berkeley) 8/21/85";
#endif
...
#include <errno.h>
#else	/* IEEE double */
const static double zero = 0.e0;
#endif
#ifndef	NeXT
static double pzero, qzero;
#endif	NeXT
const static double tpi	= .6366197723675813430755350535e0;
const static double pio4= .7853981633974483096156608458e0;
const static double p1[] = {
...
static
#ifdef	NeXT
asympt(arg, pzero, qzero) double arg; double *pzero; double *qzero; {
#else
