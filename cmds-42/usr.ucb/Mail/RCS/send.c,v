...
1.2
date     89.06.06.21.27.06;  author mmeyer;  state Exp;
branches ;
next     1.1;

1.1
date     89.05.09.13.54.39;  author mmeyer;  state Exp;
branches ;
next     ;
...
out:
	if (remote || (value("verbose") != NOSTR)) {
		while ((p = wait((union wait *)&s)) != pid && p != -1)
			;
		if (s != 0)
			senderr++;
		pid = 0;
