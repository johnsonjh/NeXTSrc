...
1.2
date     89.06.06.21.26.39;  author mmeyer;  state Exp;
branches ;
next     1.1;

1.1
date     89.05.09.14.07.59;  author mmeyer;  state Exp;
branches ;
next     ;
 ...
 */
/*
 * _STRICT_BSD_ should be taken out of the Makefile so I could
 * change the refs to raise to toupper() (see <ctype.h>)
 * MAM 5/9/89
 */
#ifdef NeXT_MOD
mail_raise(c)
