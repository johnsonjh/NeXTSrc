...
#ifndef lint
static char sccsid[] = "@(#)dumpfs.c	1.2 88/03/09 4.0NFSSRC; from	5.3 (Berkeley) 9/11/85";
#endif not lint
...
#if	NeXT_MOD
	printf("cgrotor\t%d\tfmod\t%d\tronly\t%d\tstate\t%d\n",
	    afs.fs_cgrotor, afs.fs_fmod, afs.fs_ronly, afs.fs_state);
#else	NeXT_MOD
