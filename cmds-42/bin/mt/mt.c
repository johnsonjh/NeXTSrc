...
#endif
#ifdef	NeXT
	{ MT_ISGS,	"Generic SCSI",	0,		0 },
	{ MT_ISEXB,	"Exabyte SCSI",	0,		0 },
#endif	NeXT
	{ 0 }
};
	...
	register struct mtget *bp;
{
	...
	printf("Sense Byte 0x13 = 0x%02x\n", bp->mt_ext_err0 >> 8);
	printf("Sense Byte 0x14 = 0x%02x\n", bp->mt_ext_err0 & 0xff);
	printf("Sense Byte 0x15 = 0x%02x\n", bp->mt_ext_err1 >> 8);
	printf("Sense Byte 0x16 = 0x%02x\n", bp->mt_ext_err1 % 0xff);
#else	NeXT
