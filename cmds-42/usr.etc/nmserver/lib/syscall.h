 ...
 **********************************************************************
 * HISTORY
 *  8-Oct-87  Daniel Julin (dpj) at Carnegie-Mellon University
 *	Changed VMTP syscall numbers to track the new kernel
 *	generated by sanzi for the RT APC.
 *
 *  3-Jul-87  Daniel Julin (dpj) at Carnegie-Mellon University
 *	Merged VMTP changes from Stanford (as of June 87).
 *
