...
int table_size_of_flonum_powers_of_ten = 11;

static LITTLENUM_TYPE zero[] = {     1 };
...
static LITTLENUM_TYPE minus_10 [] = {
...
static LITTLENUM_TYPE minus_11 [] = {
...
FLONUM_TYPE flonum_negative_powers_of_ten [] = {
  {zero,	zero,		zero,		  0, '+'},
...
FLONUM_TYPE flonum_positive_powers_of_ten [] = {
  {zero,	zero,		zero,		  0, '+'},
