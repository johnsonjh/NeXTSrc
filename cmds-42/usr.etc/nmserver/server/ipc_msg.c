 ...
 *
 * $Source: /os/osdev/LIBS/libs-7/etc/nmserver/server/RCS/ipc_msg.c,v $ 
 * $Source: /os/osdev/LIBS/libs-7/etc/nmserver/server/RCS/ipc_msg.c,v $ 
 *
 */
#ifndef	lint
char ipc_msg_rcsid[] = "$Header: ipc_msg.c,v 1.1 88/09/30 15:39:30 osdev Exp $";
#endif not lint
/*
 * */
 ...
 *	Included changes from 1.16 version:
 *		Initialize ool_size and ool_num fields for ipc_netmsg_hdr_t.
 *		Add debugging.
