 ...
 * Author: Ken Greer
 *
 * $Header: sccstorcs.c,v 4.7 88/10/05 17:36:30 osdev Exp $
 ...
 *
 * $Log:	sccstorcs.c,v $
 * Revision 4.7  88/10/05  17:36:30  osdev
 * Makefile changes
 * 
 * Revision 4.6  88/10/05  17:09:02  osdev
 * Makefile changes
 * 
 * Revision 4.5  88/10/05  13:58:19  root
 * New version
 * 
 * Revision 4.4  88/10/05  01:35:00  root
 * More cleanup
 * 
 * Revision 4.3  88/10/05  01:18:04  osdev
 * Makefile cleanup
 * 
 * Revision 4.2  88/10/05  01:06:01  osdev
 * Makefile cleanup
 * 
 * Revision 4.1  88/10/03  00:20:25  gk
 * New Version.
 * 
 * Revision 4.0  88/09/26  20:44:26  gk
 * Consistant version number for all constituent files
 * 
 * Revision 3.3  88/09/25  18:06:43  gk
 * Added version string
 * 
 * Revision 3.2  88/09/24  18:48:45  gk
 * Commented out version string.
 * 
 * Revision 3.1  88/09/22  21:32:07  gk
...
static char *rcs_vers = "$Source: /os/osdev/CMDS/cmds-6/usr/bin/rcs/src/RCS/sccstorcs.c,v $ $Revision: 4.7 $ $Date: 88/10/05 17:36:30 $";
